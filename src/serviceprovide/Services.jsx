...
const Services = () => {
  ...
  const serviceData = [
    ...
    shortText: "All kind of industry",
    ...
    shortText: "All kind of industry",
    fullText: "From logos to social media creatives, our graphic design services bring your brand to life with visually stunning and impactful designs tailored for digital and print platforms.",
    icon: (
                ...
                <div className="single-industries shadow d-flex align-items-center"  onMouseEnter={()=> SetIsHovered(index)} 
                  ...
                  <div class="services-heading " >
                       <h5>{service.title}</h5>
                        ...
                        <p>
                          {isHovered === index ? 
                            service.fullText:service.shortText
                          }
                          </p>
                    </div>
